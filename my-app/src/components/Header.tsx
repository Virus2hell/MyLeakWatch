        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <a href="#imageSearch" className="text-gray-300 hover:text-white transition-colors">Image Search</a>
              ...
              <div className="relative">
                ...
                {isAboutOpen && (
                  <div className="absolute right-0 mt-2 w-48 bg-slate-700 rounded-md shadow-lg py-1 z-40">
                    <a href="#about" className="block px-4 py-2 text-sm text-gray-300 hover:bg-slate-600 hover:text-white">About Us</a>
                    <a href="#contact" className="block px-4 py-2 text-sm text-gray-300 hover:bg-slate-600 hover:text-white">Contact Us</a>
                  </div>
                )}
              </div>
            </nav>
          ...
          {isMobileMenuOpen && (
            <div className="md:hidden">
              <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-slate-700/90 rounded-md mt-2">
                <a href="#" className="text-gray-300 hover:text-white block px-3 py-2 text-base">Home</a>
                <a href="#" className="text-gray-300 hover:text-white block px-3 py-2 text-base">Password Management</a>
                <a href="#imageSearch" className="text-gray-300 hover:text-white block px-3 py-2 text-base">Image Search</a>
                <a href="#" className="text-gray-300 hover:text-white block px-3 py-2 text-base">Docs</a>
                <a href="#about" className="text-gray-300 hover:text-white block px-3 py-2 text-base">About</a>
                <button
